...
(function($) {
    ...
    function jqPlot() {
        ...
        this.seriesColors = [ "#415B62", "#B0AEAE", "#c5b47f", "#579575", "#839557", "#958c12", "#953579", "#4b5de4", "#d8b83f", "#ff5800", "#0085cc", "#c747a3", "#cddf54", "#FBD178", "#26B4E3", "#bd70c7"];
