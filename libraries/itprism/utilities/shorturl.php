...
class ITPrismShortUrl {
    ...
    public function getUrl() {
        ...
        if(!in_array('curl', $installedLibraries)) {
            throw new Exception("The CURL library is disabled. You must load the library if you want to use shortener URL services.");
        }
    ...
    protected function getBitlyURL($domain = "bit.ly") {
        ...
        if(!empty($response)) {
            ...
            throw new Exception(JText::_("There was an unknown error during the process of reducing the length of the URL, using shortener service."));
        }
