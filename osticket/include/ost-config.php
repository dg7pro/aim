...
define('SECRET_SALT','e084c86d5d16ed69f7a84829f6b53c97');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','contact@alliedinfomedia.com');

#Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','localhost');
define('DBNAME','alliedin_ostic96');
define('DBUSER','alliedin_ostic96');
define('DBPASS','j95yv2n5SP');
