...
class modGoogleAnalyticsDashboardHelper
{
    ...
    function ga_generate_code( $params ){
	...
	if ($params->get('ga_enable_traffic')){
		$code.='<table width="100%"><tr><td width="50%"><div id="ga_dash_trafficdata"></div></td><td width="50%"><div id="ga_dash_nvrdata"></div></td></tr></table>';
	}	
	if ($params->get('ga_enable_pgd')){
